    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <aside class="hidden md:flex w-64 flex-col border-r border-gray-200 bg-white overflow-y-auto z-10">
            ...
            <div class="border-t border-gray-150 p-4">
                ...
                <button onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 transition">
                    <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
