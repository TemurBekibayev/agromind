                                        ...
                                        @foreach($farmer->farms as $farm)
                                            <div class="flex items-center justify-between text-xs gap-4 bg-forest-50/50 p-1 px-2 rounded border border-forest-100">
                                                ...
                                                <div class="flex items-center gap-1.5 shrink-0">
                                                    <!-- Edit Farm Button -->
                                                    <button onclick="openEditFarmModal({{ json_encode($farm->only(['id', 'name', 'size', 'soil_type', 'region_id', 'district', 'user_id'])) }})" class="text-blue-600 hover:text-blue-900 p-0.5" title="Xo'jalikni tahrirlash">
...
<div id="editFarmModal" class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[100] hidden items-center justify-center p-4">
    <div class="bg-white rounded-2xl border border-slate-200 w-full max-w-lg shadow-2xl overflow-hidden flex flex-col">
        <!-- Modal Header -->
        <div class="px-6 py-4 bg-slate-50 border-b border-slate-250 flex justify-between items-center shrink-0">
            <div>
                <h3 class="font-bold text-gray-900 text-base">Fermer Xo'jaligi Ma'lumotlarini Tahrirlash</h3>
                <p class="text-xs text-gray-500 mt-0.5">Xo'jalik nomi, maydoni va tuproq tahrirlari kabi ma'lumotlarni o'zgartirish</p>
            </div>
        ...
        <!-- Modal Form -->
        <form id="editFarmForm" action="" method="POST" class="p-6 space-y-4">
            @csrf
            
            <div>
                <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">Fermer Xo'jaligi Nomi</label>
                <input type="text" name="name" id="edit_farm_name" required class="w-full px-3 py-2 border border-slate-355 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-forest-500 bg-white">
            </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <div>
                    <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">Tuman nomi</label>
                    <input type="text" name="district" id="edit_farm_district" required class="w-full px-3 py-2 border border-slate-355 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-forest-500 bg-white">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">Maydoni (Gektar)</label>
                    <input type="number" step="0.1" name="size" id="edit_farm_size" required class="w-full px-3 py-2 border border-slate-355 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-forest-500 bg-white">
                </div>
                <div>
                    <label class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">Tuproq Turi</label>
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-slate-100 shrink-0">
                <button type="button" onclick="closeEditFarmModal()" class="px-4 py-2 border border-slate-200 rounded-lg text-xs font-semibold text-slate-700 hover:bg-slate-50 transition">Bekor qilish</button>
                <button type="submit" class="px-5 py-2 bg-forest-700 text-white rounded-lg text-xs font-semibold hover:bg-forest-600 transition">Saqlash</button>
            </div>
        </form>
    </div>
